################################################################################
# PostGisUtilities.cmake - part of CMake configuration of PostGIS
#
...
#
#   postgis_check_package_found: Test varname-FOUND for case-insensitive varname
#
################################################################################
...
#  equals signs align
#
function(postgis_report_value NAME)
  string(LENGTH "${NAME}" varlen)
  # LOG
  #message(STATUS "postgis_report_value: NAME=${NAME} (${varlen})")
  #message(STATUS "postgis_report_value: \${NAME}=${${NAME}}")
...
#  equals signs align
#
function(postgis_report_pretty PRETTYNAME VARNAME)
...
# uppercase.
#
macro(postgis_check_package_found NAME SUCCESS)
...
#
macro(postgis_report_directory_property PROPNAME)
  get_directory_property(${PROPNAME} ${PROPNAME})
  postgis_report_value(${PROPNAME})
endmacro()
...
# For instance, on Windows, libraries get ABI version suffix postgisXY.{dll|lib}.
#
function(postgis_target_output_name TARGET_NAME OUTPUT_NAME)
